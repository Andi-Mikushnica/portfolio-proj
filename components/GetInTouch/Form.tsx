...
export default function Form({formState, setFormState}: {
  ...
  const {
    ...
    resolver: zodResolver(messageSchema), defaultValues: { consent: false }
  });
    ...
    <div className='h-full'> 
      (
        ...
        p-10 bg-linear-to-b rounded-md from-gray-950 ">
            ...
            <div>
              <Checkbox {...register('consent')} onClick={() => setValue('consent', !consentState)} />
          ...
          <button disabled={isSubmitting} type="submit" className="bg-purple-600 py-2 px-6 rounded-md cursor-pointer hover:bg-purple-800">
            Submit
          </button>
          </div>
        </form>
